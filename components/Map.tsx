  ...
  return (
    <div className="w-full h-full rounded-lg shadow-inner relative">
        ...
        <div className="absolute top-2 right-2 flex flex-col gap-2">
            <button onClick={toggleDrawing} className="bg-white p-2 rounded-md shadow-md hover:bg-slate-100 transition-colors" title="Draw area">
                <DrawIcon />
            </button>
            <button onClick={clearDrawing} className="bg-white p-2 rounded-md shadow-md hover:bg-slate-100 transition-colors" title="Clear drawing">
