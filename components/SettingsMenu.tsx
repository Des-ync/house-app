...
import { BookmarkIcon, UserIcon, LockClosedIcon, BugIcon, EmailIcon, TrashIcon } from './icons';
  ...
  return (
    ...
    >
      <div className="py-1">
        ...
        <button
          onClick={() => { onShowSavedProperties(); onClose(); }}
        ...
        >
         ...
         <button
          onClick={() => { onShowEditProfile(); onClose(); }}
          className="w-full text-left flex items-center gap-3 px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700"
        >
        ...
        <button
          onClick={() => { onShowChangePassword(); onClose(); }}
          className="w-full text-left flex items-center gap-3 px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700"
        >
        ...
        <a
          href="mailto:support@domus.app?subject=Bug Report"
          className="w-full text-left flex items-center gap-3 px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700"
        >
        ...
        <button
          onClick={() => { onShowDeleteAccount(); onClose(); }}
